...
func (h *Handlers) GetTaskBurndown(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to get burndown data"})
		return
	}
...
func (h *Handlers) GetWorkloadHeatmap(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to get workload data"})
		return
	}
...
func (h *Handlers) GetUpcomingDeadlines(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to get upcoming deadlines"})
		return
	}
