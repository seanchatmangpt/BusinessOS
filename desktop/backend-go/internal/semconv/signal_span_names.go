...
const (
	...
	SignalBatchAggregate = "signal.batch.aggregate"
	...
	// Kind: internal
	// Stability: development
	SignalClassify = "signal.classify"
	...
	// Kind: internal
	// Stability: development
	SignalCompress = "signal.compress"
	...
	// Kind: internal
	// Stability: development
	SignalQualityAssess = "signal.quality.assess"
