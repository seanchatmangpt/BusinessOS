...
const (
	...
	// Kind: client
	// Stability: development
	McpConnectionEstablish = "mcp.connection.establish"
	...
	// Kind: client
	// Stability: development
	McpRegistryDiscover = "mcp.registry.discover"
	...
	// Kind: internal
	// Stability: development
	McpServerHealthCheck = "mcp.server.health_check"
	...
	// Kind: internal
	// Stability: development
	McpServerMetricsCollect = "mcp.server.metrics.collect"
	...
	// Kind: internal
	// Stability: development
	McpToolAnalyticsRecord = "mcp.tool.analytics.record"
	...
	// Kind: internal
	// Stability: development
	McpToolCacheLookup = "mcp.tool.cache.lookup"
	...
	// Kind: internal
	// Stability: development
	McpToolCompose = "mcp.tool.compose"
	...
	// Kind: internal
	// Stability: development
	McpToolValidate = "mcp.tool.validate"
	...
	// Kind: internal
	// Stability: development
	McpToolVersionCheck = "mcp.tool.version_check"
	...
	// Kind: server
	// Stability: development
	McpToolExecute = "mcp.tool_execute"
	...
	// Kind: client
	// Stability: development
	McpTransportConnect = "mcp.transport.connect"
)