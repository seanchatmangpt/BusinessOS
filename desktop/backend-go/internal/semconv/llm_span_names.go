...
const (
	...
	LlmAdapterApply = "llm.adapter.apply"
	...
	// Kind: internal
	// Stability: development
	LlmCacheLookup = "llm.cache.lookup"
	...
	// Kind: internal
	// Stability: development
	LlmChainOfThought = "llm.chain_of_thought"
	...
	// Kind: internal
	// Stability: development
	LlmContextManage = "llm.context.manage"
	...
	// Kind: internal
	// Stability: development
	LlmDistillationTrain = "llm.distillation.train"
	...
	// Kind: internal
	// Stability: development
	LlmEmbeddingGenerate = "llm.embedding.generate"
	...
	// Kind: internal
	// Stability: development
	LlmFewShotRetrieve = "llm.few_shot.retrieve"
	...
	// Kind: internal
	// Stability: development
	LlmFinetuneRun = "llm.finetune.run"
	...
	// Kind: internal
	// Stability: development
	LlmMultimodalProcess = "llm.multimodal.process"
	...
	// Kind: internal
	// Stability: development
	LlmPromptRender = "llm.prompt.render"
	...
	// Kind: internal
	// Stability: development
	LlmRagRetrieve = "llm.rag.retrieve"
	...
	// Kind: internal
	// Stability: development
	LlmResponseValidate = "llm.response.validate"
	...
	// Kind: internal
	// Stability: development
	LlmSamplingConfigure = "llm.sampling.configure"
	...
	// Kind: internal
	// Stability: development
	LlmStructuredOutputGenerate = "llm.structured_output.generate"
	...
	// Kind: internal
	// Stability: development
	LlmTokenBudget = "llm.token.budget"
	...
	// Kind: internal
	// Stability: development
	LlmToolOrchestrate = "llm.tool.orchestrate"
)