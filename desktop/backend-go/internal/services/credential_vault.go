...
// --- Sorx Integration Methods ---
// These methods provide the interface that Sorx skills will use to get credentials

// GetCredentialForSkill retrieves a credential for use by a Sorx skill
