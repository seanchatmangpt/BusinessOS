...
CREATE INDEX idx_osa_apps_deployment_port ON osa_generated_apps(deployment_port);
CREATE INDEX idx_osa_apps_category ON osa_generated_apps(category);
CREATE INDEX idx_osa_apps_workspace_category ON osa_generated_apps(workspace_id, category);
-- Sandbox indexes (Migration 091)
CREATE INDEX idx_osa_apps_container_id ON osa_generated_apps(container_id) WHERE container_id IS NOT NULL;
CREATE INDEX idx_osa_apps_sandbox_status ON osa_generated_apps(sandbox_status) WHERE sandbox_status != 'none';
CREATE INDEX idx_osa_apps_sandbox_port ON osa_generated_apps(sandbox_port) WHERE sandbox_port IS NOT NULL;
CREATE INDEX idx_osa_apps_health_status ON osa_generated_apps(health_status) WHERE health_status != 'unknown';
...
CREATE INDEX idx_sandbox_events_app_id ON sandbox_events(app_id);
...
CREATE TABLE osa_generated_files (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- =============================================================================
-- OSA APP REGISTRY (from migration 078)
-- =============================================================================
