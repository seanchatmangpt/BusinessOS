...
UPDATE projects
SET name = $2, description = $3, status = $4, priority = $5, client_name = $6, client_id = $7, project_type = $8, project_metadata = $9::jsonb, start_date = $10, due_date = $11, visibility = $12, updated_at = NOW()
WHERE id = $1
RETURNING id, user_id, name, description, status, priority, client_name, client_id, project_type, project_metadata, start_date, due_date, completed_at, visibility, owner_id, created_at, updated_at
`
