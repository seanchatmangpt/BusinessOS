...
func (h *Handlers) GetCalendarStats(c *gin.Context) {
	...
	if err != nil {
		utils.RespondInternalError(c, slog.Default(), "get calendar stats", err)
		return
	}
...
func (h *Handlers) GetUpcomingCalendarEvents(c *gin.Context) {
	...
	if err != nil {
		utils.RespondInternalError(c, slog.Default(), "get upcoming events", err)
		return
	}
...
func (h *Handlers) GetTodayCalendarEvents(c *gin.Context) {
	...
	if err != nil {
		utils.RespondInternalError(c, slog.Default(), "get today's events", err)
		return
	}
