...
CREATE INDEX IF NOT EXISTS idx_osa_workflows_app ON osa_workflows(app_id);
...
CREATE INDEX IF NOT EXISTS idx_osa_files_workflow ON osa_generated_files(workflow_id);
CREATE INDEX IF NOT EXISTS idx_osa_files_app ON osa_generated_files(app_id);
CREATE INDEX IF NOT EXISTS idx_osa_files_type ON osa_generated_files(file_type);
CREATE INDEX IF NOT EXISTS idx_osa_files_language ON osa_generated_files(language);
CREATE INDEX IF NOT EXISTS idx_osa_files_status ON osa_generated_files(installation_status);
CREATE INDEX IF NOT EXISTS idx_osa_files_hash ON osa_generated_files(content_hash);
CREATE INDEX IF NOT EXISTS idx_osa_files_path ON osa_generated_files(file_path);
CREATE INDEX IF NOT EXISTS idx_osa_files_name ON osa_generated_files(file_name);
CREATE INDEX IF NOT EXISTS idx_osa_files_latest ON osa_generated_files(is_latest) WHERE is_latest = true;
...
CREATE INDEX IF NOT EXISTS idx_osa_module_deps_module ON osa_module_dependencies(module_id);
CREATE INDEX IF NOT EXISTS idx_osa_module_deps_depends ON osa_module_dependencies(depends_on_module_id);
CREATE INDEX IF NOT EXISTS idx_osa_module_deps_type ON osa_module_dependencies(dependency_type);
