				...
				<tr>
					...
					<th class="bos-database-table__add-column">
						<Tooltip content="Add column" side="top">
							<button
								class="bos-database-table__add-column-btn"
			...
			<tbody>
					...
					>
						...
						<td class="bos-database-table__row-handle">
							<div class="bos-database-table__row-actions">
								{#if isHovered}
									<button class="bos-database-table__row-grip">
										<GripVertical />
									</button>
									<Menu>
										{#snippet trigger()}
											<button class="bos-database-table__row-menu">
												<MoreHorizontal />
											</button>
										{/snippet}
				...
				<tr class="bos-database-table__add-row">
					...
					<td colspan={visibleColumns().length + 1}>
						<button
							class="bos-database-table__add-row-btn"
