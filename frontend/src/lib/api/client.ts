...
class ApiClient {
  ...
  async updateConversation(
    id: string,
    data: { title?: string; context_id?: string | null },
  ) {
  ...
  async getConversationsByContext(contextId: string) {
    return this.request<Conversation[]>(
      `/chat/conversations?context_id=${encodeURIComponent(contextId)}`,
    );
  }
  ...
  async getContexts(filters?: {
    ...
    return this.request<ContextListItem[]>(
  ...
  async updateContextBlocks(id: string, data: BlocksUpdateData) {
    return this.request<Context>(`/contexts/${id}/blocks`, {
      method: "PATCH",
      body: data,
    });
  }
  ...
  async enableContextSharing(id: string) {
    return this.request<ShareResponse>(`/contexts/${id}/share`, {
      method: "POST",
    });
  }
  ...
  async duplicateContext(id: string) {
    return this.request<Context>(`/contexts/${id}/duplicate`, {
      method: "POST",
    });
  }
  ...
  async aggregateContext(data: AggregateContextRequest) {
    return this.request<AggregateContextResponse>("/contexts/aggregate", {
      method: "POST",
      body: data,
    });
  }
  ...
  async createTeamMember(data: CreateTeamMemberData) {
    return this.request<TeamMemberResponse>("/team", {
      method: "POST",
      body: data,
    });
  }
  ...
  async updateTeamMember(id: string, data: UpdateTeamMemberData) {
    return this.request<TeamMemberResponse>(`/team/${id}`, {
      method: "PUT",
      body: data,
    });
  }
  ...
  async updateTeamMemberStatus(id: string, status: string) {
    return this.request<TeamMemberResponse>(
      `/team/${id}/status?new_status=${encodeURIComponent(status)}`,
      {
        method: "PATCH",
      },
    );
  ...
  async updateTeamMemberCapacity(id: string, capacity: number) {
    return this.request<TeamMemberResponse>(
      `/team/${id}/capacity?capacity=${capacity}`,
      {
        method: "PATCH",
      },
    );
  ...
  async updateFocusItem(
    ...
    return this.request<FocusItem>(`/dashboard/focus/${id}`, {
      method: "PUT",
      body: data,
    });
  }
  ...
  async updateTask(id: string, data: UpdateTaskData) {
    return this.request<Task>(`/dashboard/tasks/${id}`, {
      method: "PUT",
      body: data,
    });
  }
  ...
  async toggleTask(id: string) {
    return this.request<Task>(`/dashboard/tasks/${id}/toggle`, {
      method: "POST",
    });
  }
  ...
  async updateDailyLog(
    id: string,
    data: { content?: string; energy_level?: number },
  ) {
    return this.request<DailyLog>(`/daily/logs/${id}`, {
      method: "PUT",
      body: data,
    });
  }
  ...
  async getArtifacts(filters?: {
    ...
    const query = params.toString();
    return this.request<ArtifactListItem[]>(
  ...
  async linkArtifact(
    id: string,
    data: { project_id?: string; context_id?: string },
  ) {
    return this.request<Artifact>(`/artifacts/${id}/link`, {
      method: "PATCH",
      body: data,
    });
  }
  ...
  async activateNode(id: string) {
    return this.request<NodeActivateResponse>(`/nodes/${id}/activate`, {
      method: "POST",
    });
  }
  ...
  async reorderNode(id: string, newOrder: number) {
    return this.request(`/nodes/${id}/reorder?new_order=${newOrder}`, {
      method: "POST",
    });
  }
  ...
  async deleteContact(clientId: string, contactId: string) {
    return this.request(`/clients/${clientId}/contacts/${contactId}`, {
      method: "DELETE",
    });
  }
  ...
  async getClientInteractions(clientId: string, skip = 0, limit = 50) {
    return this.request<InteractionResponse[]>(
      `/clients/${clientId}/interactions?skip=${skip}&limit=${limit}`,
    );
  }
  ...
  async updateDeal(clientId: string, dealId: string, data: UpdateDealData) {
    return this.request<DealResponse>(`/clients/${clientId}/deals/${dealId}`, {
      method: "PUT",
      body: data,
    });
  }
  ...
  async getCalendarEvents(filters?: {
    ...
    return this.request<CalendarEvent[]>(
      `/integrations/google/calendar/events${query ? `?${query}` : ""}`,
    );
  }
  ...
  async createCalendarEvent(data: CreateCalendarEventData) {
    return this.request<CalendarEvent>("/integrations/google/calendar/events", {
      method: "POST",
      body: data,
    });
  }
  ...
  async deleteCalendarEvent(id: string) {
    return this.request(`/integrations/google/calendar/events/${id}`, {
      method: "DELETE",
    });
  }

  async syncCalendar() {
    return this.request<{ message: string; synced_count: number }>(
  ...
  async getTodayEvents() {
    ...
    return this.request<CalendarEvent[]>(
      `/integrations/google/calendar/events?start=${today}&end=${today}`,
    );
  }
  ...
  async getUpcomingEvents(limit?: number) {
    ...
    return this.request<CalendarEvent[]>(
      `/integrations/google/calendar/events${params}`,
    );
  }
  ...
  async retranscribeVoiceNote(noteId: string) {
    return this.request<VoiceNote>(`/voice-notes/${noteId}/retranscribe`, {
      method: "POST",
    });
  }
  ...
  async deleteProfilePhoto() {
    return this.request<{ message: string }>("/profile/photo", {
      method: "DELETE",
    });
  }
}
