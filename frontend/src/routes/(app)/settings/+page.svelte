			...
			<div class="max-w-4xl mx-auto p-6">
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
					...
					<div class="card text-center py-6">
						<svg class="w-8 h-8 mx-auto mb-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
							<path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
							<path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
						</svg>
						<h3 class="font-medium text-gray-900 dark:text-white mb-2">Advanced Settings</h3>
					...
					<div class="card text-center py-6">
						...
						<h3 class="font-medium text-gray-900 dark:text-white mb-2">Thinking Settings</h3>
						<p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
					...
					<div class="card text-center py-6">
						...
						<h3 class="font-medium text-gray-900 dark:text-white mb-2">Reasoning Templates</h3>
						<p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
				...
				{#if activeTab === 'account'}
					<div class="space-y-6">
						...
						<!-- Privacy & Compliance -->
						<div class="card">
							<h2 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Privacy & Compliance</h2>
						...
						<div class="card border-red-200 dark:border-red-900">
							...
							{#if !showDeleteConfirmation}
								<div class="flex items-center justify-between">
									<div>
										...
										<p class="text-sm text-gray-500 dark:text-gray-400">Permanently delete your account and all data. This cannot be undone.</p>
									</div>
									<button
							...
							{:else}
								<div class="space-y-4 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
									<p class="text-sm text-red-700 dark:text-red-300">Your account will be scheduled for deletion. All your data will be permanently removed within 30 days. Type <strong>DELETE</strong> to confirm.</p>
									<input
										type="text"
										bind:value={deleteConfirmText}
										placeholder="Type DELETE to confirm"
										class="w-full px-3 py-2 border border-red-300 dark:border-red-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
									/>
									<div class="flex gap-3">
										<button
											onclick={handleDeleteAccount}
											disabled={deleteConfirmText !== 'DELETE' || isDeletingAccount}
											class="btn text-sm bg-red-600 text-white hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
										>
						...
						{:else}
							...
							<div class="card">
								...
								<div class="space-y-6">
									<!-- Tone -->
									<div>
										<span class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Preferred Tone</span>
									...
									<!-- Verbosity -->
									<div>
										<span class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Response Length</span>
									...
									<!-- Format -->
									<div>
										<span class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Response Format</span>
										<div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
							...
							<div class="card">
								...
								<div class="space-y-4">
									<div>
										<span class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Your Expertise</span>
									...
									<div>
										<span class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Learning Interests</span>
